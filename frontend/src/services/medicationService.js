...
export const medicationService = {
  ...
  async create(formData) {
    const res = await fetch(`${API_BASE_URL}/medications`, { method: 'POST', headers: authHeaders(), body: formData });
    return handleResponse(res);
  },
  ...
  async bulkImport(file) {
    ...
    fd.append('file', file);
    const res = await fetch(`${API_BASE_URL}/medications/bulk-import`, { method: 'POST', headers: authHeaders(), body: fd });
    return handleResponse(res);
  },
  ...
  async scanCreate({ photoFile, photoUrl = '', manualOverrides = {} }) {
    ...
    const res = await fetch(`${API_BASE_URL}/medications/scan-create`, { method: 'POST', headers: authHeaders(), body: fd });
    return handleResponse(res);
  },
};
